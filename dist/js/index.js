...
function getDogsAPI() {
    fetch(URL_API)
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            showUserBtn === null || showUserBtn === void 0 ? void 0 : showUserBtn.addEventListener("click", event => {
                console.log('här ska det komma info');
                let li = document.createElement("li");
                listOfUsers === null || listOfUsers === void 0 ? void 0 : listOfUsers.appendChild(li);
            ...
            showDogBtn === null || showDogBtn === void 0 ? void 0 : showDogBtn.addEventListener("click", event => {
                let li = document.createElement("li");
                ...
                hiddenDogsList === null || hiddenDogsList === void 0 ? void 0 : hiddenDogsList.appendChild(li);
            });
        }
    });
    listOfDogs === null || listOfDogs === void 0 ? void 0 : listOfDogs.classList.toggle("hidden");
}
;
getDogsAPI();
